...
export const defaultKPICards: KPICardConfig[] = [
  ...
  {
    id: 'staffMemberRegistration',
    title: '직원별 회원 등록',
    description: '직원이 담당하여 등록한 신규 회원 수',
    category: '직원',
    icon: <Badge size={20} className="text-white" />,
    color: 'bg-stone-500',
    enabled: true
  },
  {
    id: 'staffConsultation',
    title: '직원별 상담 건수',
    description: '직원이 처리한 회원 상담 및 업무 건수',
    category: '직원',
  ...
  {
    id: 'staffPerformanceScore',
    title: '직원별 성과 점수',
    description: '매출, 회원등록, 상담 건수를 종합한 성과 점수',
    category: '직원',
